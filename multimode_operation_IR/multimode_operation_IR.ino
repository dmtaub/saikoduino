...
void sendcolor() {
  ...
  analogWrite(redPin, (int)rgbw[0]*scaler);
  analogWrite(greenPin, (int)rgbw[1]*scaler);
  analogWrite(bluePin, (int)rgbw[2]*scaler);
  analogWrite(whitePin, (int)rgbw[3]*scaler);
}
